  ...
  return (
    <div className={styles.container}>
      <div className={styles.wrapper}>
        <div className={styles.counter} id="timeline">
          {time} second before roll ...{" "}
        </div>
        ...
        <div className={styles.balancePanel}>
          ...
          <div className={styles.controls}>
            ...
            <div className={styles.betControls}>
              ...
              <Button
                content="1/2"
                onClick={() => setValue(Math.floor(+value / 2) + "")}
                type={ButtonTypes.OUTLINED}
              />
            </div>
          </div>
      ...
      <div className={styles.posContainer}>
        <ColorPosition
          type={ColorPositionTypes.RED}
          betsData={MOCK_RED_USERS}
        />
        <ColorPosition
          type={ColorPositionTypes.GREEN}
          betsData={MOCK_GREEN_USERS}
        />
        <ColorPosition
          type={ColorPositionTypes.BLACK}
          betsData={MOCK_BLACK_USERS}
        />
      </div>
    </div>
  );
